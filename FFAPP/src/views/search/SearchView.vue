...
<template>
    <div class="search-view" >
        ...
        <div v-if="!searchValue" class="search-view__history">
            <div class="label">History Search</div>
        ...
        <div v-else class ="search-view__result">
            ...
            <template v-if="searchState === DONE">
                <div class = "result-item" v-for="v in searchResult" :key="v.label">
                    ...
                    <div class = "count">about {{ v.resultCount }} results</div>
                </div>
                <div class="no-result" v-if="!searchResult.length">Sorry, We don't have these food </div>
